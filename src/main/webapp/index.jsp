		                    ...
		                    <div class="col">
		                        <div class="card h-100">
		                            ...
		                            <div class="card-body">
		                                ...
		                                <p class="card-text">Matematica del siglo XIX, pionera en programacion junto a Babbage, conceptualizo el "programa" para la Maquina Analítica. Su legado inspira mujeres en ciencia y tecnologia, trascendiendo barreras temporales.</p>
		                            </div>
		                        </div>
		                    </div>
		                </div>
